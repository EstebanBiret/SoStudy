...
public class DataInitializer implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        user1.setPassword(hashPassword("a"));
        ...
        event1.setEventDescription("Rencontre des développeurs Java de la région");
        event1.setEventBeginningDate("2025-01-15");
        event1.setEventEndDate("2025-01-13");
        event1.setEventLocation("Paris, France");
        event1.setEventImagePath("/images/events/event1.jpg");
        ...
        user1.getSubscribedEvents().add(event1);
        ...
        event2.setEventDescription("Formation pratique sur la sécurisation des applications Spring");
        event2.setEventBeginningDate("2025-01-20");
        event2.setEventEndDate("2025-01-22");
        event2.setEventLocation("Lyon, France");
        event2.setEventImagePath("/images/events/event2.jpg");
        event2.setUserCreator(user2);
        
        // Ajout des utilisateurs intéressés par le deuxième événement
        event2.addUser(user2);
        event2.addUser(user3);
        user2.getSubscribedEvents().add(event2);
